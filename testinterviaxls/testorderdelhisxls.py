...
xlsfile1 = r'F:/testexcel/testorddelhis.xls'
reload(sys)
sys.setdefaultencoding('utf-8')



def testorddelhisexcel(xlsfile=xlsfile1):
    printtitle('START testorddelhisexcel')
    ...
    for i in range(1,nrows):
        ...
        #print data1
        url='/order/delhistory'
        
        testcodework(datatemp, url, ex_code)
      
if __name__=="__main__":
    testorddelhisexcel(xlsfile1)
