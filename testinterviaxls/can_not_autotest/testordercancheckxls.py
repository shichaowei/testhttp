...
xlsfile1 = r'F:/testexcel/testordercancheck.xls'
reload(sys)
sys.setdefaultencoding('utf-8')



def testordercancheexcel(xlsfile=xlsfile1):
    printtitle('START testordercancheexcel')
    ...
    for i in range(1,nrows):
        ...
        #print data1
        url='/order/canclecheck'
        
        testcodework(datatemp, url, ex_code)
      
if __name__=="__main__":
    testordercancheexcel(xlsfile1)
