...
xlsfile1 = r'F:/testexcel/testorderlist.xls'
reload(sys)
sys.setdefaultencoding('utf-8')



def testorderlistexcel(xlsfile=xlsfile1):
    printtitle('START testorderlistexcel')
    ...
    for i in range(1,nrows):
        ...
        orderType=api_sheet.cell_value(i,3)        #租车订单数字ID
        offset=api_sheet.cell_value(i,4)
        ...
        datatemp={'uid':uid,'orderType':orderType,'offset':offset,\
